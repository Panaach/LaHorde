...
public class ObjetJeu {	
	public static int getId(ObjetJeu obj) {	
		...
		if (String.valueOf(obj.getClass()).equals("class horde.Planche")) // si c'est une planche alors je renvoie le code 0
			...
			return 1;
		else if (String.valueOf(obj.getClass()).equals("class horde.Ration")) // si mon objet est une ration je renvoie le code 2
			return 2;
		else if (String.valueOf(obj.getClass()).equals("class horde.Gourde")) // si mon objet est une gourde je renvoie le code 3
			return 3;
